...
const TRANSLATIONS = {
  ...
  en: {
    ...
    welcomeGreeting: 'Arrival Greeting',
...
function applyTranslations(lang) {
  ...
  document.title = t.pageTitle || 'Otel Misafir Anket Sistemi';
  ...
  if (comments && t.generalCommentsPlaceholder) comments.placeholder = t.generalCommentsPlaceholder;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (savedLang && LANG_NAMES[savedLang]) {
    const currentLangName = document.getElementById('currentLangName');
    if (currentLangName) currentLangName.textContent = LANG_NAMES[savedLang];
  }
});
