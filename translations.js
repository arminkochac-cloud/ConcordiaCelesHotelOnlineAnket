const translations = {
    ...
    en: {
        ...
        generalComments: "General Thoughts and Comments (0-500 characters)",
        ...
        dailyRoomCleaning: "Daily Room Cleaning and Order",
        ...
        breakfastQuality: "Breakfast Buffet Presentation & Quality",
        lunchVariety: "Lunch Buffet Variety",
        lunchQuality: "Lunch Buffet Presentation & Quality",
        dinnerVariety: "Dinner Buffet Variety",
        dinnerQuality: "Dinner Buffet Presentation & Quality",
        alacarteQuality: "À la Carte Restaurant Presentation & Quality",
        ...
        sportsAreas: "Activity and Sports Areas",
    ...
    de: {
        ...
        kvkkText: "Ich stimme der Verarbeitung meiner personenbezogenen Daten zum Zweck der Gästebefragung zu.",
        ...
        previousStay: "Haben Sie schon einmal in unserem Hotel übernachtet? *",
        praisedStaff: "Mitarbeiter, den Sie loben möchten",
        generalComments: "Ihre allgemeinen Kommentare (0-500 Zeichen)",
        ...
        dailyRoomCleaning: "Tägliche Zimmerreinigung und Ordnung",
        minibarService: "Minibar-Service",
        publicAreaCleaning: "Sauberkeit der öffentlichen Bereiche",
        beachPoolCleaning: "Sauberkeit von Strand- und Poolbereich",
        housekeepingStaffCare: "Freundlichkeit und Aufmerksamkeit des Personals",

        breakfastVariety: "Vielfalt des Frühstücksbuffets",
        breakfastQuality: "Präsentation und Qualität des Frühstücksbuffets",
        lunchVariety: "Vielfalt des Mittagsbuffets",
        lunchQuality: "Präsentation und Qualität des Mittagessens",
        dinnerVariety: "Vielfalt des Abendbuffets",
        dinnerQuality: "Präsentation und Qualität des Abendessens",
        ...
        sportsAreas: "Aktivitäts- und Sportbereiche",
        ...
        spaServices: "Sauna- und Hammam-Service",
    ...
    ru: {
        ...
        kvkkText: "Я даю согласие на обработку моих персональных данных в целях оценки удовлетворенности гостей.",
        ...
        previousStay: "Вы ранее останавливались в нашем отеле? *",
        praisedStaff: "Сотрудник, которого вы хотели бы похвалить",
        generalComments: "Ваши общие комментарии (0-500 символов)",
        willReturnQuestion: "Вы вернётесь снова? *",
        ...
        barStaffCare: "Вежливость и внимание персонала",
        ...
        snackbarRestaurant: "Обслуживание Snackbar Restaurant",
        alacarteRestaurant: "Обслуживание ресторана à la carte и внимание персонала",
        restaurantStaffCare: "Вежливость и внимание персонала",
        ...
        technicalStaffCare: "Вежливость и внимание персонала",

        daytimeActivities: "Дневные активности с анимационной командой",
        sportsAreas: "Спортивные и активные зоны",
        eveningShows: "Вечерние активности и шоу",
        miniclubActivities: "Активности мини-клуба",
        entertainmentStaffCare: "Вежливость и внимание персонала",

        landscaping: "Ландшафт / благоустройство",
        spaServices: "Сауна и хамам",
        shopBehavior: "Общее поведение торговцев в отеле",
        priceQuality: "Соотношение цены и качества",

        roomNumberPlaceholder: "например: 305",
        emailPlaceholder: "example@email.com",
        praisedStaffPlaceholder: "например: Ayşe / Mehmet",
        generalCommentsPlaceholder: "Вы можете написать свои комментарии здесь..."
    },
    ...
    pl: {
        ...
        email: "Adres e-mail",
        kvkkText: "Wyrażam zgodę na przetwarzanie moich danych osobowych w celu badania satysfakcji gości.",
        ...
        previousStay: "Czy byłeś/-aś już wcześniej w naszym hotelu? *",
        praisedStaff: "Pracownik, którego chcesz pochwalić",
        generalComments: "Twoje ogólne komentarze (0-500 znaków)",
        willReturnQuestion: "Czy wrócisz ponownie? *",
        wouldRecommend: "Czy poleciłbyś/-abyś nas innym? *",
        yes: "Tak",
        no: "Nie",
        ...
        dailyRoomCleaning: "Codzienne sprzątanie i porządek",
        ...
        breakfastQuality: "Prezentacja i jakość śniadania",
        lunchVariety: "Różnorodność bufetu obiadowego",
        lunchQuality: "Prezentacja i jakość obiadu",
        dinnerVariety: "Różnorodność bufetu kolacyjnego",
        dinnerQuality: "Prezentacja i jakość kolacji",
        ...
        sportsAreas: "Strefy aktywności i sportu",
        ...
        spaServices: "Sauna i hammam",
        shopBehavior: "Ogólne zachowanie sprzedawców w hotelu",
    ...
    ro: {
        ...
        kvkkText: "Îmi dau acordul ca datele mele personale să fie prelucrate în scopul evaluării satisfacției oaspeților.",
        kvkkLink: "Notificare de confidențialitate",
        next: "Înainte",
        back: "Înapoi",
        submit: "Trimite sondajul",
        thankYouTitle: "Vă mulțumim!",
        thankYouMessage: "Opinia dvs. este foarte importantă pentru noi.",
        newSurvey: "Sondaj nou",
        previousStay: "Ați mai stat la noi înainte? *",
        praisedStaff: "Angajatul pe care doriți să-l lăudați",
        generalComments: "Comentariile dvs. generale (0-500 caractere)",
        ...
        dailyRoomCleaning: "Curățenia și ordinea zilnică",
        ...
        breakfastQuality: "Prezentarea și calitatea micului dejun",
        lunchVariety: "Varietatea bufetului de prânz",
        lunchQuality: "Prezentarea și calitatea prânzului",
        dinnerVariety: "Varietatea bufetului de cină",
        dinnerQuality: "Prezentarea și calitatea cinei",
        ...
        sportsAreas: "Zone de activitate și sport",
...
function applyTranslations(lang) {
    ...
    if (langHeader && t.languageHeader) {
        langHeader.textContent = t.languageHeader;
    }

    const currentLangName = document.getElementById("currentLangName");
    if (currentLangName) {
        currentLangName.textContent = languageNames[lang] || "Türkçe";
    }
    ...
    Object.entries(sectionTitleKeys).forEach(([sectionId, key]) => {
        const title = document.querySelector(`#${sectionId} .section-title h2`);
        if (title && t[key] !== undefined) {
    ...
    if (roomNumber && t.roomNumberPlaceholder) {
        roomNumber.placeholder = t.roomNumberPlaceholder;
    }

    const email = document.querySelector('input[name="email"]');
    if (email && t.emailPlaceholder) {
        email.placeholder = t.emailPlaceholder;
    }

    const praisedStaff = document.querySelector('input[name="praisedStaff"]');
    if (praisedStaff && t.praisedStaffPlaceholder) {
        praisedStaff.placeholder = t.praisedStaffPlaceholder;
    }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (savedLang && translations[savedLang]) {
        ...
        const currentLangName = document.getElementById("currentLangName");
        if (currentLangName) {
            currentLangName.textContent = "Türkçe";
        }
    }
});
